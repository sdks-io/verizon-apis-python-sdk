...
from verizonthingspacequalityofserviceapiendpoints.verizonthingspacequalityofserviceapiendpoints_client import VerizonthingspacequalityofserviceapiendpointsClient
...
class ControllerTestBase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client = VerizonthingspacequalityofserviceapiendpointsClient(config=cls.config)
